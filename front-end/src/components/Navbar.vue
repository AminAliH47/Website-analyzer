<template>
    <div class="navbar bg-primary shadow shadow-gray-400 w-11-5/12 sticky top-4 mt-4 mx-auto 
    rounded-xl z-50 transition-colors" id="navbar">
        <div class="navbar-start">
            <a href="https://github.com/TP-Techs/Website-analyzer" target="_blank"
                class="btn btn-ghost text-base-100 lg:hidden">
                <label>
            ...
            <router-link :to="{ name: 'IndexPage' }"
                class="btn btn-ghost text-base-100 gap-2 normal-case text-md xl:text-xl">
                Analyze again
                <PresentationChartBarIcon class="h-6 w-6" />
            </router-link>
        </div>
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal text-base-100 p-0">
                <li>
                    <a href="https://github.com/TP-Techs/Website-analyzer" target="_blank"
                        class="btn btn-link normal-case gap-2 text-base-100 text-xl">
                        Github
                        <label>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                viewBox="0 0 16 16">
        ...
        <div class="navbar-end">
            <a class="btn gap-2 text-md xl:text-xl">
                Donate
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 xl:h-6 xl:w-6 text-base-100 fill-current"
                    viewBox="0 0 16 16">
...
<script>
import { PresentationChartBarIcon } from '@heroicons/vue/outline'
